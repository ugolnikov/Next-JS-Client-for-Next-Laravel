...
export default function Page({ params }) {
    ...
    if (notFound) return (
        <div className="flex flex-col items-center justify-center min-h-[50vh]">
            ...
            <p className="text-gray-600">К сожалению, запрашиваемый товар не существует.</p>
        </div>
    )
                    ...
                    <div className="md:w-1/2 p-8">
                        <div className="space-y-6">
                            ...
                            <div className="bg-gray-50 p-6 rounded-lg">
                                <h2 className="text-lg font-semibold mb-4">Информация о продавце</h2>
                                <div className="flex items-center space-x-4">
                                    <div className="flex-shrink-0">
                                        <div className="w-20 h-20 rounded-full overflow-hidden bg-white shadow-md">
                                            <ImageWithLoader
                                                src={product.data.seller.logo}
                                                alt={product.data.seller.company_name}
                                                width={80}
                                                height={80}
                                    ...
                                    <div className="flex-grow">
                                        <h3 className="text-xl font-medium text-gray-900">
                                            {product.data.seller.company_name}
                                        </h3>
